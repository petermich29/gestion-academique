"""Ajout TypeComposante et relation

Revision ID: 0c30b6abdc19
Revises: 428e0ae78ea5
Create Date: 2025-12-04 20:39:24.682006
...
revision: str = '0c30b6abdc19'
down_revision: Union[str, Sequence[str], None] = '428e0ae78ea5'
...
def upgrade() -> None:
    ...
    op.add_column('composantes',
        sa.Column('TypeComposante_id_fk', sa.String(7), nullable=True)
    )

    op.create_foreign_key(
        None,
        'composantes', 'types_composante',
        ['TypeComposante_id_fk'], ['TypeComposante_id']
    )
...
def downgrade() -> None:
    ...
    sa.PrimaryKeyConstraint('ModeInscription_id', name='modes_inscription_pkey'),
    sa.UniqueConstraint('ModeInscription_code', name='modes_inscription_ModeInscription_code_key', postgresql_include=[], postgresql_nulls_not_distinct=False),
    sa.UniqueConstraint('ModeInscription_label', name='modes_inscription_ModeInscription_label_key', postgresql_include=[], postgresql_nulls_not_distinct=False),
    postgresql_ignore_search_path=False
    )
    op.create_table('types_composante',
    sa.Column('TypeComposante_id', sa.VARCHAR(length=7), autoincrement=False, nullable=False),
    sa.Column('TypeComposante_label', sa.VARCHAR(length=50), autoincrement=False, nullable=False),
    sa.Column('TypeComposante_description', sa.TEXT(), autoincrement=False, nullable=True),
    sa.PrimaryKeyConstraint('TypeComposante_id', name=op.f('types_composante_pkey')),
    sa.UniqueConstraint('TypeComposante_label', name=op.f('types_composante_TypeComposante_label_key'), postgresql_include=[], postgresql_nulls_not_distinct=False)
    )
    ...
    sa.PrimaryKeyConstraint('TypeEnseignement_id', name=op.f('types_enseignement_pkey')),
    sa.UniqueConstraint('TypeEnseignement_code', name=op.f('types_enseignement_TypeEnseignement_code_key'), postgresql_include=[], postgresql_nulls_not_distinct=False),
    sa.UniqueConstraint('TypeEnseignement_label', name=op.f('types_enseignement_TypeEnseignement_label_key'), postgresql_include=[], postgresql_nulls_not_distinct=False)
    )
    ...
    sa.Column('Institution_abbreviation_historique', sa.VARCHAR(length=20), autoincrement=False, nullable=True),
    ...
    sa.Column('Composante_description_historique', sa.TEXT(), autoincrement=False, nullable=True),
    sa.Column('Composante_abbreviation_historique', sa.VARCHAR(length=20), autoincrement=False, nullable=True),
    ...
    sa.Column('Cycle_id_fk', sa.VARCHAR(length=10), autoincrement=False, nullable=False),
    sa.ForeignKeyConstraint(['Cycle_id_fk'], ['cycles.Cycle_id'], name=op.f('niveaux_Cycle_id_fk_fkey')),
    sa.PrimaryKeyConstraint('Niveau_id', name=op.f('niveaux_pkey')),
    sa.UniqueConstraint('Niveau_code', name=op.f('niveaux_Niveau_code_key'), postgresql_include=[], postgresql_nulls_not_distinct=False)
    )
    ...
    sa.PrimaryKeyConstraint('Etudiant_id', name=op.f('etudiants_pkey'))
    )
    ...
    sa.Column('Institution_id_fk', sa.VARCHAR(length=10), autoincrement=False, nullable=False),
    sa.ForeignKeyConstraint(['Institution_id_fk'], ['institutions.Institution_id'], name=op.f('composantes_Institution_id_fk_fkey')),
    sa.PrimaryKeyConstraint('Composante_id', name=op.f('composantes_pkey')),
    sa.UniqueConstraint('Composante_code', name=op.f('uq_composante_code'), postgresql_include=[], postgresql_nulls_not_distinct=False)
    )
    # ### end Alembic commands ###
