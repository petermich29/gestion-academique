"""Add description and abbreviation to ComposanteHistorique

Revision ID: 428e0ae78ea5
Revises: 64e2537f10a4
Create Date: 2025-12-04 18:50:23.431422
...
revision: str = '428e0ae78ea5'
down_revision: Union[str, Sequence[str], None] = '64e2537f10a4'
...
def upgrade() -> None:
    """Upgrade schema."""
    op.add_column('composantes_historique', sa.Column('Composante_description_historique', sa.Text(), nullable=True))
    op.add_column('composantes_historique', sa.Column('Composante_abbreviation_historique', sa.String(length=20), nullable=True))
...
def downgrade() -> None:
    ...
    sa.Column('Parcours_id_fk', sa.VARCHAR(length=15), autoincrement=False, nullable=False),
    sa.Column('AnneeUniversitaire_id_fk', sa.VARCHAR(length=9), autoincrement=False, nullable=False),
    sa.ForeignKeyConstraint(['AnneeUniversitaire_id_fk'], ['annees_universitaires.AnneeUniversitaire_id'], name=op.f('unites_enseignement_AnneeUniversitaire_id_fk_fkey')),
    sa.ForeignKeyConstraint(['Parcours_id_fk'], ['parcours.Parcours_id'], name=op.f('unites_enseignement_Parcours_id_fk_fkey')),
    sa.ForeignKeyConstraint(['Semestre_id_fk'], ['semestres.Semestre_id'], name=op.f('unites_enseignement_Semestre_id_fk_fkey')),
    sa.PrimaryKeyConstraint('UE_id', name=op.f('unites_enseignement_pkey')),
    sa.UniqueConstraint('UE_code', 'Parcours_id_fk', 'AnneeUniversitaire_id_fk', name=op.f('uq_ue_code_parcours_annee'), postgresql_include=[], postgresql_nulls_not_distinct=False)
    )
    ...
    sa.PrimaryKeyConstraint('SessionExamen_id', name=op.f('sessions_examen_pkey')),
    sa.UniqueConstraint('SessionExamen_code', name=op.f('sessions_examen_SessionExamen_code_key'), postgresql_include=[], postgresql_nulls_not_distinct=False),
    sa.UniqueConstraint('SessionExamen_label', name=op.f('sessions_examen_SessionExamen_label_key'), postgresql_include=[], postgresql_nulls_not_distinct=False)
    )
    ...
    sa.Column('Niveau_id_fk', sa.VARCHAR(length=10), autoincrement=False, nullable=False),
    sa.ForeignKeyConstraint(['Niveau_id_fk'], ['niveaux.Niveau_id'], name=op.f('semestres_Niveau_id_fk_fkey')),
    sa.PrimaryKeyConstraint('Semestre_id', name=op.f('semestres_pkey')),
    sa.UniqueConstraint('Niveau_id_fk', 'Semestre_numero', name=op.f('uq_niveau_numero_semestre'), postgresql_include=[], postgresql_nulls_not_distinct=False),
    sa.UniqueConstraint('Semestre_code', name=op.f('semestres_Semestre_code_key'), postgresql_include=[], postgresql_nulls_not_distinct=False)
    )
