...
from app.routers import composantes_routes, institutions_routes, mentions_routes, metadonnees_routes, ue_routes, parcours_routes # <--- AJOUT
...
app.include_router(ue_routes.router, prefix="/api") # <--- AJOUT
