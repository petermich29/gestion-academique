...
// Import des sous-composants refactorés
import { EcManagerModal, UeFormModal, StructureView } from "./components/ParcoursComponents";
...
const ParcoursDetail = () => {
  ...
  const handleDeleteEC = async (id) => {
      ...
      try {
          const res = await fetch(`${API_BASE_URL}/api/ecs/${id}`, { method: "DELETE" });
