...
// ❌ Suppression de l'import de PageWrapper
...
    .sort((a, b) => {
      const vA =
        sortField === "code" ? a.Institution_code : a.Institution_nom;
      const vB =
        sortField === "code" ? b.Institution_code : b.Institution_nom;
...
    >
      <div
        className={`${AppStyles.addCard.iconContainer} ${
          grid ? "w-12 h-12 text-2xl" : "w-8 h-8 text-lg"
        }`}
      >
        <PlusIcon />
      </div>
...
  if (isLoading)
    return (
      // Remplacement du PageWrapper par le conteneur AppStyles.pageContainer
      <div className={AppStyles.pageContainer}>
        {/* Titre principal */}
        <div className={AppStyles.header.container}>
            <h2 className="text-3xl font-bold text-gray-800 tracking-tight">Administration</h2>
        </div>
        {/* Ligne de séparation (Bleu Marine 1px) */}
        <hr className="mt-1 mb-4 border-t border-blue-900" />
...
  return (
    // ✅ Conteneur principal (remplace PageWrapper)
    <div className={AppStyles.pageContainer}>
...
                  ? `http://127.0.0.1:8000${inst.Institution_logo_path}`
                  : null
              }
...
      </div>
      ...
      {/* --- MODAL AJOUT / MODIFICATION (Formulaire) --- */}
      <DraggableModal
        isOpen={modalOpen}
        onClose={closeModal}
